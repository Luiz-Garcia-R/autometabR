...
#'
#' @param normalized_data A \code{metabolNorm} object generated by \code{metabol.normalization()}.
...
#'
#' @return Invisibly returns the updated \code{metabolNorm} object containing:
#' \describe{
